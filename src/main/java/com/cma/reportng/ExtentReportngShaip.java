...
public final class ExtentReportngShaip {
	...
	public synchronized static ExtentReports createExtentReports() {
		...
		if (Objects.isNull(extent)) {
			...
			String reportPath = FrameworkConstants.getExtentReportPath() + ReportName + ".html";
			...
			extent.setSystemInfo("Executed on Environment: ", PropertyUtils.getValue("urlCP"));
			extent.setSystemInfo("Executed on Browser: ", PropertyUtils.getValue("browser"));
