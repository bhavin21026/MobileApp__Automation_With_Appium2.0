...
public class TestCommons {
	...
	protected void navigateTo(String linkName) {
		try {
			...
			DriverManager.getDriver().navigate().to(linkName);
	...
	protected Object[][] getData( String filename) throws IOException {

		List<HashMap<String, String>> l = getJsonData(
				FrameworkConstants.getJsonDataPath()+"//"+filename+".json");
